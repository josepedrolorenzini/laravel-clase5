...
@section('content')
    <div class="relative isolate bg-white">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            ...
            <form action="{{ route('contact2-submit') }}" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
                @csrf
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            <x-input name="nombre" id="nombre"  Label="nombre"  placeholder='nombre' />
                        </div>
                        <div>
                            <x-input name="lastname" id="lastname"   Label="lastname"  placeholder="lastname" />
                        </div>
                        <div>
                            <x-input name="email" id="email"  Label="Email" placeholder="name"/>
                        </div>
                        <div>
                            <x-input name="phonenumber" id="phonenumber"  Label="phonenumber"  placeholder="phone" />
                        </div>
                        <div>
                            <x-textarea name='message'  Label='Message' id='message' nRows='4'/>
                        </div>
                    </div>
                    <div class="mt-8 flex">
                        <button type="submit"
