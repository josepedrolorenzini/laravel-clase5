...
<?php endif; ?>
                            <?php if(Route::has('/')): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                <?php endif; ?>
                                <a href="<?php echo e(route('/')); ?>" class="rounded-md px-3 py-2" > home</a>
...
<?php $component = App\View\Components\Card::resolve(['title' => 'card 1','content' => 'The content','link' => 'www.codigofacilito.com'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH C:\xampp72\htdocs\2024\php\codigoFacilito\laravel\clase5-component\resources\views/home.blade.php ENDPATH**/ ?>